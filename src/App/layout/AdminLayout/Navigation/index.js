...
class Navigation extends Component {
    ...
    render() {
        ...
        if (this.props.preLayout && this.props.preLayout !== '' && this.props.preLayout !== 'layout-6' && this.props.preLayout !== 'layout-8') {
                ...
                .map(group => ({
                    ...
                    children: group.children
                        ? group.children.filter(item =>
                            !item.permition || item.permition.some(p => userPermissions.includes(p))
                        )
                        : [],
                }))
                .filter(group => group.children.length > 0), // Elimina grupos vacíos
        };
        ...
        let navContent = (
            <div className="navbar-wrapper">
                ...
                <NavContent navigation={filteredNavigation.items} />
            </div>
        );
