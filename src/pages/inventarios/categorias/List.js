...
const Marcas = () => {
  ...
  return (
    <div className="mb-4">
      <h5 className="mb-3">Listado de Categorias</h5>
      <Button onClick={abrirModalCrear}>Nueva Categorias</Button>
          ...
          {data.map((prov, idx) => (
            <tr key={idx}>
              ...
              <td className="text-center">
                <OverlayTrigger overlay={<Tooltip>Ver Categoria</Tooltip>}>
                  <Button className="btn btn-outline-secondary btn-sm me-1" onClick={() => handleVer(prov)}>
                    <FiEye />
                  </Button>
                </OverlayTrigger>
                <OverlayTrigger overlay={<Tooltip>Editar Categoria</Tooltip>}>
                  <Button className="btn btn-outline-secondary btn-sm" onClick={() => handleEditar(prov)}>
                    <FiEdit />
                  </Button>
                </OverlayTrigger>
                <OverlayTrigger overlay={<Tooltip>Eliminar Categoria</Tooltip>}>
