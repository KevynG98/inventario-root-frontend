          ...
          <Row className="mt-2">
            <Col md={4}>
              <Form.Group>
                ...
                <Form.Control {...register('codigo_inventario', { required: true })} readOnly={readOnly} />
                {errors.codigo_inventario && <small className="text-danger">Código SKU es obligatorio</small>}
              </Form.Group>
            </Col>
            <Col md={4}>
              <Form.Group>
