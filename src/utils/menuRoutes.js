...
const staticRoutes = [
  ...
  // REPORTS – by default open to all module roles (and doctor).
  {
    title: 'Reportes',
    icon: <FiBarChart2 />,
    roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8 && r !== 9)],
    children: [
      { title: 'Historial General', url: '/dashboard/reportes/historial-general', icon: <FiFileText />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8 && r !== 9)] },
      { title: 'Imprimir Expediente', url: '/dashboard/futuro', icon: <FiFileText />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Historico de Admisiones', url: '/dashboard/futuro', icon: <FiArchive />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Facturacion', url: '/dashboard/futuro', icon: <FiDollarSign />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Usuarios', url: '/dashboard/reportes/users', icon: <FiUsers />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Medicos', url: '/dashboard/futuro', icon: <FiUser />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Inventarios', url: '/dashboard/reportes/inventarios', icon: <FiDatabase />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Caja', url: '/dashboard/futuro', icon: <FiCreditCard />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Honorarios Medicos', url: '/dashboard/futuro', icon: <FiDollarSign />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Listado de SKU Cobrados', url: '/dashboard/futuro', icon: <FiList />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Listado de SKU Precios', url: '/dashboard/futuro', icon: <FiDollarSign />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Ordenes de Compra', url: '/dashboard/futuro', icon: <FiFilePlus />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Consignacion', url: '/dashboard/futuro', icon: <FiPackage />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Controlados', url: '/dashboard/futuro', icon: <FiShield />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Ingresos - Egresos', url: '/dashboard/futuro', icon: <FiDollarSign />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
      { title: 'Directorio Extensiones', url: '/dashboard/futuro', icon: <FiBookOpen />, roles: [R.ADMIN, ...ALL_NON_ADMIN.filter(r => r !== 6 && r !== 7 && r !== 8)] },
    ],
  },
];
